...
import 'package:flutter_firebase/ui/screens/home/create_folder.dart';
      ...
      children: [
        ...
        Container(
          ...
          child: InkWell(
            ...
            child: Row(
              children: [
                Icon(Icons.create_new_folder_outlined, size: screenHeight(context, 25)),
                SizedBox(width: screenWidth(context, 10)),
          ...
          child: InkWell(
            onTap: () async {
              ...
              await Future.delayed(const Duration(seconds: 2))
                  .whenComplete(() => Loader.disposeLoader(context));
              provider.setDrawerTappedCheck(false);
